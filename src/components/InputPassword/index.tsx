...
const InputPassword = React.forwardRef<HTMLInputElement, InputPasswordProps & React.HTMLProps<HTMLInputElement>>((props, ref) => {
  ...
  return <div className={classNames("app-input app-input-password", className)} style={{ height }}>
    <div className={classNames("app-input-password__content", { "app-input--focused": inputIsFocused })}>
